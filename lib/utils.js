module.exports = {
  ...
  getOptions: (options) => {
    ...
    if (typeof defaultOptions.marginLeft !== 'number') {
      throw new TypeError(`Invalid offset: ${defaultOptions.offset}`)
    }

    if (typeof defaultOptions.marginTop !== 'number') {
      throw new TypeError(`Invalid offset: ${defaultOptions.offset}`)
    }

    if (typeof defaultOptions.marginBottom !== 'number') {
      throw new TypeError(`Invalid offset: ${defaultOptions.offset}`)
    }
